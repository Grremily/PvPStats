...
public sealed unsafe class PlayerCharacterState : IDisposable
{
    ...
    private readonly PvPEventService     _dutyEventService;
    ...
    public PlayerCharacterState()
    {
        ...
        _dutyEventService = Service.PvPEventService;
    ...
    private void DutyStarted(PvPStartedEventArgs eventArgs)
    {
    ...
    private void DutyEnded(PvPEndedEventArgs eventArgs)
    {
        AgentModule pvpResults = new AgentModule();
        AgentInterface* pvpResultsInterface = pvpResults.GetAgentByInternalId(AgentId.ColosseumRecord);
        _allianceState = AllianceState.NoGroup;
